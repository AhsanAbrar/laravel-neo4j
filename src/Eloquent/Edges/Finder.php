...
class Finder extends Delegate {
     ...
     *
     * @param  \Ahsan\Neo4j\Eloquent\Model  $parentModel
     * @param  \Ahsan\Neo4j\Eloquent\Model  $relatedModel
     ...
     * @param  \Ahsan\Neo4j\Eloquent\Model  $relatedModel
     * @param  string $direction
     * @return \Ahsan\Neo4j\Eloquent\Edges\Edge[In|Out]|null
     */
     ...
     * @return \Ahsan\Neo4j\Eloquent\Edges\HyperEdge
     */
     ...
     * @param  \Everyman\Neo4j\Relationship $relation
     * @param  string $direction
     * @return \Ahsan\Neo4j\Eloquent\Edges\Edge[In|Out]
     */
