<?php namespace Ahsan\Neo4j\Eloquent;
...
class Builder extends IlluminateBuilder {
     ...
     *
     * @param  \Ahsan\Neo4j\Eloquent\Model $parent       The parent model
     * @param  \Ahsan\Neo4j\Eloquent\Model $related      The related model
     * @param  string                             $relationship
     * @return \Ahsan\Neo4j\Query\Builder|static
     */
     ...
     * @param  \Ahsan\Neo4j\Eloquent\Model $related      The related model
     * @param  string                             $relationship
     * @return \Ahsan\Neo4j\Eloquent|static
     */
     ...
     *
     * @param string $holder
     * @param \Ahsan\Neo4j\Eloquent\Model|string  $model String in the case of morphs where we do not know
     ...
     *
     * @param  string $mutation
     * @return \Ahsan\Neo4j\Eloquent\Model
     */
     ...
     *
     * @param  \Ahsan\Neo4j\Eloquent\Relations\* $relation
     * @return [type]
     */
