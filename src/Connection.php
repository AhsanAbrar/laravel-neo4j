...
class Connection extends IlluminateConnection {
	...
	{
		return $this->getClient()->run($query, $this->prepareBindings($bindings));
	}
	 ...
	 *
	 * @return \Ahsan\Neo4j\Query\Grammars\CypherGrammar
	 */
	 ...
	 *
	 * @return \Ahsan\Neo4j\Schema\Builder
	 */
