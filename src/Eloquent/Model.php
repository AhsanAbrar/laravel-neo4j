...
namespace Ahsan\Neo4j\Eloquent;

use Ahsan\Neo4j\Helpers;
use Illuminate\Database\Eloquent\Collection;
use Ahsan\Neo4j\Eloquent\Relations\HasOne;
use Ahsan\Neo4j\Eloquent\Relations\HasMany;
use Ahsan\Neo4j\Eloquent\Relations\MorphTo;
use Ahsan\Neo4j\Eloquent\Relations\BelongsTo;
use Ahsan\Neo4j\Eloquent\Relations\MorphMany;
use Ahsan\Neo4j\Eloquent\Relations\HyperMorph;
use Ahsan\Neo4j\Eloquent\Relations\OneRelation;
use Ahsan\Neo4j\Query\Builder as QueryBuilder;
use Ahsan\Neo4j\Eloquent\Relations\MorphedByOne;
use Ahsan\Neo4j\Eloquent\Relations\BelongsToMany;
use Illuminate\Database\Eloquent\Model as IlluminateModel;
use Ahsan\Neo4j\Eloquent\Builder as EloquentBuilder;
...
abstract class Model extends IlluminateModel {
     ...
     *
     * @param  \Ahsan\Neo4j\Query\Builder $query
     * @return \Ahsan\Neo4j\Eloquent\Builder|static
     */
     ...
     *
     * @return \Ahsan\Neo4j\Query\Builder
     */
     ...
     * @param  string  $type
     * @param  string  $key
     * @return \Ahsan\Neo4j\Eloquent\Relations\HasMany
     */
     ...
     * @param  string  $ownerKey
     * @param  string  $relation
     * @return \Ahsan\Neo4j\Eloquent\Relations\BelongsToMany
     */
    ...
    {
        // To escape the error:
        // PHP Strict standards:  Declaration of Ahsan\Neo4j\Eloquent\Model::belongsToMany() should be
     ...
     * @param  string $relation
     * @param  string $key
     * @return \Ahsan\Neo4j\Eloquent\Relations\HyperMorph
     */
     ...
     * @return \Ahsan\Neo4j\Eloquent\Relations\MorphMany
     */
    public function morphMany($related, $name, $type = null, $id = null, $localKey = null)
    {
        // To escape the error:
        // Strict standards: Declaration of Ahsan\Neo4j\Eloquent\Model::morphMany() should be
     ...
     *
     * @param  \Ahsan\Neo4j\Eloquent\Model $related
     * @param  string $type
     * @param  string $key
     * @param  string $relation
     * @return \Ahsan\Neo4j\Eloquent\Relations\MorphedByOne
     */
